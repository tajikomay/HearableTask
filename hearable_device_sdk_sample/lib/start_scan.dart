...
import 'package:hearable_device_sdk_sample/downhill.dart';
...
import 'package:hearable_device_sdk_sample/slalom.dart';
import 'dart:io';
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              title: const Text(('ダウンヒル')),
              onTap: () {
                Navigator.push(
                    context,
                    PageRouteBuilder(
                      pageBuilder: (context, animation, secondaryAnimation) {
                        return const Downhill();
                      },
                      transitionsBuilder:
                          (context, animation, secondaryAnimation, child) {
                        const Offset begin = Offset(1.0, 0.0); // 右から左
